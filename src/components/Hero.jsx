  ...
  return (
   ...
   items-center justify-between min-h-[calc(90vh-6rem)]">
    ...
    <div data-aos="fade-right"
     ...
     className="max-w-xl ml-[5%] z-10 mt-[90%] md:mt-[60%] lg:mt-0">
        ...
        <p className='text-base sm:text-lg tracking-wider text-gray-400 max-w-[25rem] lg:max-w-[30rem]'>
            a picture in words of somebody
            /something or of s
            omething that happened.
        </p>
        ...
        <div className='flex gap-4 mt-12'>
            ...
            hover:bg-[#1a1a1a]" href="#">Documentation<i class='bx bx-link-external'></i></a>
            ...
            hover:text-white" href="#">GetStarted<i class='bx bx-link-external'></i></a>
        </div>
    </div>
    ...
    <Spline data-aos="fade-zoom-in"
     ...
     data-aos-delay="300"
     data-aos-offset="0" 
     data-aos-duration="3000"className='absolute lg:top-0
    top-[20%]
    bottom-0 lg:left-[25%]
    sm:left-[-2%]
    h-full' scene="https://prod.spline.design/DwXSJNSuLh-TY8DL/scene.splinecode" />
